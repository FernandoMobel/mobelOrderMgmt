  ...
  <body>
    <div class="container-fluid px-0">
      <div class="row mx-0">
        ...
        <div class="col-1 bg-dark d-flex justify-content-end d-print-none px-0">
          <a class="mr-3" href="mailto:mos.support@mobel.ca" data-toggle="tooltip" data-placement="left" title="Need some help? please send an email to mos.support@mobel.ca">
