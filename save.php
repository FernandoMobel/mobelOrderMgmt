...
//include 'orderXMLCV.php'; File for XML creation (still development)
...
if($_POST['mode'] == "saveEditedItem"){
    if(itemUpdateConstraintsOK("orderItem",$_POST['column'])==0){
        ...
        if(strcmp($_POST['column'],'position')==0){
            ...
            $sql = "update orderItem set position=".$_POST['value']." where id=".$_POST['itemID'];
            //echo $sql;
            opendb($sql);
...
if($_POST['mode'] == "orderScheduled"){
    ...
    <body>
        ...
        <div class=\"bg-light container-fluid\">
            <div class=\"row py-3\">
                <div class=\"col-12 d-flex justify-content-center\">
                    <h3 class=\"mx-5\">Hello ".$row['firstName']." ".$row['lastName']."!</h3>
                </div>
                <div class=\"col-12 d-flex justify-content-center\">
            ...
            <table class=\"table my-0\">
                <tr class=\"text-center\">
                    <td><h5>Order ID: ".$_POST['oid']."</h5></td>
                    <td><h5>Tag Name: ".$row['tagName']."</h5></td>
                    <td><h5>PO: ".$row['po']."</h5></td>
                    <td><h5>Date Submitted: ". substr($row['dateSubmitted'],0,10) ."</h5></td>
                </tr>
            </table>
            <!--div style=\"height: 10px\" class=\"bg-dark mx-3\">&nbsp</div>
            <div class=\"row\">
