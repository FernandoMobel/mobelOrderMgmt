...
//                      getPrice($qty, $base, $sizePrice, $parentPrice, $parentPercent,                           $DFactor,$IFactor,            $FFactor,$GFactor,$SFactor,                   $drawerCharge,$smallDrawerCharge,$largeDrawerCharge,                           $DApplies, $IApplies,            $FApplies, $GApplies, $SApplies, $drawers,                         $smallDrawerFronts,$largeDrawerFronts, $H, $W, $D, $minSize,  $methodID){
            ...
            if($isParent === 1){
                ...
                //if($_SERVER['HTTP_REFERER']=="https://mos.mobel.ca/Order2.php?OID=1"){
                    echo "<button type=\"button\" onclick=\"cleanEdit(); $('#editItemPID').val(". $parentID .");\" class=\"btn btn-primary btn-sm editbutton\" data-toggle=\"modal\" data-target=\"#editItemModal\"><span class=\"ui-icon ui-icon-circle-plus\"></button></td>";
                //}else{
                ...
                echo $tdStyle ."&nbsp;&nbsp;<span class=\"ui-icon ui-icon-pencil btn-primary\" onClick=editItems(".$row['item'].",". $row['sid'] .") data-toggle=\"modal\" title=\"Edit\" data-target=\"#editItemModal\"></span></td>";
            }
